...
const Header = () => {
    ...
    return (
        <div>
            <div className="nav-bg px-4 py-5 mx-auto bg-black text-white sm:max-w-xl md:max-w-full lg:max-w-[1440px] md:px-24 lg:px-8">
                <div className="relative flex items-center justify-between">
                    <Link
                        to="/"
                        aria-label="Shahadat's"
                        title="Shahadat's"
                    ...
                    <ul className="flex items-center hidden space-x-8 lg:flex"> {/* menu option start*/}
                        {menuOptions}
